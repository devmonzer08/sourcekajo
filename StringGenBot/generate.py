...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if not is_bot:
        t = "» » ✔️الان ارسل رقمك مع رمز دولتك , مثال :201095559102"
    else:
    ...
    if not is_bot:
        ...
        try:
            ...
            try:
                ...
                await two_step_msg.reply("» آلبآسـورد غلطـ يـﮯقلب\n\nآعمـل آسـترت وجرب تآنيـﮯ وآتآگد مـ\n\n /start ", quote=True, reply_markup=InlineKeyboardMarkup(gen_button))
                return
    else:
        if telethon:
